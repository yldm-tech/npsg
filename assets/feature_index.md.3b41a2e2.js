import{_ as s,c as n,o as a,b as e}from"./app.96d4c4b1.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"feature/index.md","lastUpdated":1675154306000}'),l={name:"feature/index.md"},p=e(`<h3 id="目录结构" tabindex="-1">目录结构</h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">src</span></span>
...
<span class="line"><span style="color:#24292e;"></span></span></code></pre></div>`,2),o=[p];function t(c,r,i,y,d,g){return a(),n("div",null,o)}const h=s(l,[["render",t]]);export{u as __pageData,h as default};
